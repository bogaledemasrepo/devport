export default [
  {
    ...
    longDescription:
      "Built a comprehensive e-commerce platform featuring real-time inventory management, advanced product filtering, secure payment processing with Stripe, and an intuitive admin dashboard. Implemented server-side rendering for optimal SEO and performance.",
  ...
  },
  {
    ...
    longDescription:
      "Created a secure mobile banking application with biometric authentication, real-time transaction monitoring, and comprehensive financial management tools. Implemented end-to-end encryption and fraud detection systems.",
  ...
  },
  {
    ...
    longDescription:
      "Designed and developed a stunning portfolio website featuring smooth animations, interactive elements, and optimized performance. Built with modern web technologies and deployed with continuous integration.",
    ...
    technologies: {
      frontend: ["Gatsby", "React", "GSAP", "Styled Components"],

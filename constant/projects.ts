...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "RESTful API built with Express.js and PostgreSQL for managing tasks and projects. Includes JWT authentication and role-based access control.",
    category: "Backend",
  ...
  },
  {
    ...
    description:
      "Cross-platform mobile app built with React Native. Features real-time weather data, location services, and beautiful animations.",
    category: "Mobile",
  ...
  },
  {
    ...
    description:
      "Real-time chat application backend with Socket.io, Redis, and MongoDB. Supports group chats, file sharing, and message encryption.",
    category: "Backend",
  ...
  },
  {
    ...
    description:
      "Mobile fitness tracking app with workout logging, progress charts, and social features. Built with Flutter for iOS and Android.",
    category: "Mobile",

              ...
              <div className="space-y-6">
                ...
                <FadeIn delay={0.3}>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    <span className="text-foreground font-semibold">complex backend logic</span> and{" "}
                    <span className="text-foreground font-semibold">elegant frontend interfaces</span>. I believe great code is invisible—it just works.
                  </p>
                </FadeIn>
                  ...
                  <Card className="bg-primary/3 border-primary/10 rounded-2xl">
                    <CardContent className="p-6 flex gap-4">
                      ...
                      <p className="italic text-muted-foreground">
                        The best code is not just functional—it&apos;s elegant and tells a story.
                      </p>
                    </CardContent>
                  </Card>
                </FadeIn>
        ...
        <div className="container mx-auto px-6">
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              My technical toolkit, honed through years of building enterprise-grade applications.
            </p>
          </FadeIn>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <motion.div 
              ...
              className="absolute left-0 md:left-8 top-0 w-0.5 bg-linear-to-b from-primary via-primary/50 to-transparent hidden md:block" 
            />

            <div className="space-y-12">
              {TIMELINEEVENT.map((event, index) => (
                <FadeIn key={event.title || index} delay={index * 0.1} className="relative md:pl-20">
                  {/* Timeline Dot */}
                  ...
                  <Card className="border-border/60 hover:shadow-xl hover:shadow-primary/5 transition-all">
                    <CardContent className="p-8">
                      <div className="flex flex-wrap items-center gap-3 mb-4">
                        <Badge className="bg-primary/10 text-primary border-none rounded-md px-3 py-1">
                          {event.year}
                        </Badge>
